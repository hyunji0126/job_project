        ...
        <div class="modal_body2">
            <div class="pw_find_form">
                <form method="post" class="passwordFind">
                    ...
                    <input type="button" value="인증번호 전송" class="submit-btn pw_check submit" id="find_pw">
                    <input type="button" value="Close" class="submit-btn modal_end_btn ">
        ...
        <div class="modal_body4">
            <div class="new_pw_form">
                <%-- <form action="<c:url value='/user/modifyPw' />" method="post" class="newPw_form"> --%>
                   <input type="text" name="userId" class="new_pw text-field" id="myId" placeholder="아이디 입력">
                    <input type="password" name="userPw" class="new_pw text-field" id="newPw" placeholder="비밀번호 입력">
                    <input type="password" class="new_pw_ck text-field" id="newPwCk" placeholder="비밀번호 확인">
...
$(function(){
   ...
   $('#find_pw').click(function(){
      if($('#find_pw_id').val() === ''){
		...
		$('#newPw').blur(function(){
		if(!getPwCheck.test($('#newPw').val())){
		 alert('특수기호 포함 8자 이상으로 입력하세요');
		  }
							  		
		});
                        
                        //비밀번호 변경
                        $("#mod_pw_sub").click(function(){
