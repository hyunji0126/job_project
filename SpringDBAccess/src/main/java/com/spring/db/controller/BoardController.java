...
public class BoardController {
	...
	@GetMapping("/content")
	public void content(@ModelAttribute("boardNo") int board_no, Model model) {
	...
	@GetMapping("/modify")
	public void modify(@ModelAttribute("boardNo") int board_no, Model model) {
	...
	@PostMapping("/modify")
	public String modify(@RequestParam("boardNo") int board_no, BoardVO vo) {
		System.out.println("/board/modify : POST " + board_no);
		service.updateArticle(vo, board_no);
		return "redirect:/board/content?boardNo=" + board_no;
	}
	//삭제는 알아서 작성해 주세요.
	@GetMapping("/delete")
